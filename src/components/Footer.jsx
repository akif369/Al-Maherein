  ...
  return (
    <div className="bg-[#2B2525] font-robo">
      <div className="md:flex text-[13px] list-none gap-20 py-4 pt-2 md:pt-8 text-white px-2">
        <h1 className="font-della text-lg  md:text-4xl md:m-16 my-auto text-nowrap px-4 py-3">
          AL MAHEREIN
        </h1>
        ...
        <div className="flex w-full md:gap-16 max-md:justify-between max-lg:flex-wrap">
          ...
          <div className="w-48">
            ...
            <div className="flex items-center bg-[#FFFBED] rounded-full shadow-lg overflow-hidden font-montserrat h-8">
              ...
              <button
                onClick={() => {
                  alert("Thank you Shopping with US. AL MAHEREIN!");
                }}
                className="bg-[#D68933] p-3 flex items-center justify-center"
              >
          ...
          <div className="font-light mt-4 md:mt-0">
            <h1 className="text-[16px] font-bold">Contact</h1>
            <ul className="grid gap-2 mt-3">
              <li>Sami: +971501455856</li>
              <li>Rajesh: +971501462655</li>
              <li>John Panicker: +971501462554</li>
            </ul>
          </div>
        </div>
      </div>
